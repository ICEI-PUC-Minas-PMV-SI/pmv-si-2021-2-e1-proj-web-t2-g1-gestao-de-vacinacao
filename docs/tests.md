...
| *Cadastramento de Administrador*  | L1 | Validar botão *“Cadastrar”* | Ter acesso ao SGI | 1. Abrir a página *Cadastramento de Profissional* <br> 2. Clicar em *“Cadastrar”* | Ao clicar em *Cadastrar* e ter adicionado os`dados corretamente no formulário são salvos` na base de dados do SGI, uma mensagem de confirmação é exibida, e a contagem dos registros salvos é atualizada  | **OK**  |
| *Cadastramento de Administrador*  | L2 | Validar botão *“limpar”* | Ter acesso ao SGI | 1. Abrir a página *Cadastramento de Profissional* <br> 2. Clicar em *“Limpar”* | Ao clicar em *limpar* vai limpar os dados inserido no formulario,   | **OK**   | 
| *Cadastramento de Administrador*  | L3 | Validar botão *“excluir”* | Ter acesso ao SGI | 1. Abrir a página *Cadastramento de Profissional* <br> 2. Clicar em *“excluir”* | Ao selecionar uma pessoa na tabela e clicar em *excluir* vai excluir a pessoa selecionada   | **OK**    |
